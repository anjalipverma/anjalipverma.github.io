...
<p style="margin-top:20px;" strong style="color:#000000;"><strong style="color:#000000;">Teaching Assistant - University of Texas at Austin (2016-Present) </strong></p>

<!---
<br />(<a href="" target="_blank">Course evaluations</a>)</p>
-->
<ul style="margin-top:-20px;">
  <li style="color:#074f62;">Microeconomic Theory  <em style="font-size:12px">(Prepared and led weekly review lectures)</em> 
  <li style="color:#074f62;">Microeconomic Theory for Business <em style="font-size:12px">(Prepared and led weekly review lectures)</em>  </li>

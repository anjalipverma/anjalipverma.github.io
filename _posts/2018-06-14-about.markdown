...
<p style="margin-top:30px;"><a href="{{ site.baseurl }}/files/Disruptive Interactions_JMP_Anjali P Verma.pdf" target="_blank"><font size="3" style="color:#C35900"><b>Disruptive Interactions: Long-run Peer Effects of Disciplinary Schools</b> - <font size="2" style="color:#000000;"> with A. Yonah Meiselman</font><strong>[ JOB MARKET PAPER ] </font></a></strong><br>  </p>
  
<p style="margin-top:30px;"><a href="{{ site.baseurl }}/files/Clean Energy, Gender, and Labor Supply.pdf" target="_blank"><font size="3" style="color:#C35900"><b>Clean Energy Access: Gender Disparity, Health, and Labor Supply</b> - <font size="2" style="color:#000000;">with Imelda</font></font></a>
